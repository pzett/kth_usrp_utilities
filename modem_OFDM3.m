function [waveform, parameters]=modem_OFDM3(Nsymbols,modulation_ix,known_pos,use_pilot_subcarriers,prepend_sync_seq,bits_in,re_order)
%
%
% function [waveform, parameters]=modem_OFDM1(Nsymbols,known_pos,use_pilot_subcarriers,prepend_sync_seq,bits_in,re_order)
%
...
% 5MHz and -5Hz to -0.625MHz at 25MHz sample-rate.
...
known_symbol(1:9)=[ 1 + 1i ,1 - 1i,-1 + 1i,-1 + 1i,-1 + 1i ,1 + 1i ,-1 + 1i ,-1 + 1i,1+i];
known_symbol(33:40)=[1 + 1i   1 - 1i  -1 + 1i  -1 + 1i  -1 + 1i   1 + 1i  -1 + 1i  -1 + 1i];
