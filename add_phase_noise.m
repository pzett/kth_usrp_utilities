...
%%% Good
%phase_noise_freq=[100,1e3,10e3,100e3,1e6];%,10e6];
%phase_noise_power=[-83,-85,-85,-112,-132];%,-145];

%%% Fair
%phase_noise_freq=[1e3,10e3,100e3];
%phase_noise_power=[-76,-82,-94];

%%% Bad
%phase_noise_freq=[1e3,10e3,100e3,1e6];
%phase_noise_power=[-30,-60,-90,-100];
